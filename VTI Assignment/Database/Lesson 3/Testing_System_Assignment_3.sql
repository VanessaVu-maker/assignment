...
VALUES
	...
	(8, 's1D2022@gmail.com', 'Hoang2', 'Nguyen Huy Hoang', '4', '1', '2022-02-03'),
	(9, 'fbc45@gmail.com', 'Lan2', 'Nguyen Thanh Lan', '9', '3', '2022-02-06'),
...
VALUES
    ...
    (6, 'Java Question', '4', '1', '4', '2022-02-06'),
	(7, 'Python Question', '7', '1', '8', '2022-02-06'),
	(8, 'C++ Question',  '3', '1', '1', '2022-02-06'),
	(9, 'PHP Question',  '2', '1', '4', '2022-02-06'),
...
VALUES
	...
	(3, 'B23BWU', 'C++Test', 3, 60, 5, '2022-02-02'),
	...
	(8, 'B23BWU', 'C++Test', 2, 60, 7, '2022-02-02'),
...
WHERE LENGTH(FullName) = (SELECT MAX(LENGTH(FullName))
		FROM (SELECT * FROM `Account` WHERE DepartmentID = 3) AS `Bang Tam`)
        AND DepartmentID = 3;
...
SELECT QuestionID, count(QuestionID) AS 'No. of answers'
FROM `answer`
GROUP BY QuestionID
